...
declare namespace engine {
   ...
   */
  function getParameter<TGroup extends MixxxControls.Group>(
    group: TGroup,
    name: MixxxControls.Ctrl<TGroup>,
  ): number;
   ...
   */
  function setParameter<TGroup extends MixxxControls.Group>(
    group: TGroup,
    name: MixxxControls.CtrlRW<TGroup>,
    newValue: number,
  ): void;
   ...
   */
  function getParameterForValue<TGroup extends MixxxControls.Group>(
    group: TGroup,
    name: MixxxControls.Ctrl<TGroup>,
    value: number,
  ): number;
   ...
   * @param name Name of the control e.g. "play_indicator"
   */
  function reset<TGroup extends MixxxControls.Group>(
    group: TGroup,
    name: MixxxControls.CtrlRW<TGroup>,
  ): void;
   ...
   *          https://manual.mixxx.org/latest/chapters/appendix/mixxx_controls.html
   */
  function getDefaultValue<TGroup extends MixxxControls.Group>(
    group: TGroup,
    name: MixxxControls.Ctrl<TGroup>,
  ): number;
   ...
   */
  function getDefaultParameter<TGroup extends MixxxControls.Group>(
    group: TGroup,
    name: MixxxControls.Ctrl<TGroup>,
  ): number;

  type CoCallback<TGroup extends MixxxControls.Group> = (
    value: number,
    group: TGroup,
    name: MixxxControls.Ctrl<TGroup>,
  ) => void;
   ...
   * @param name Name of the control e.g. "play_indicator"
   */
  function trigger<TGroup extends MixxxControls.Group>(
    group: TGroup,
    name: MixxxControls.CtrlRW<TGroup>,
  ): void;
   ...
   */
  function softTakeover<TGroup extends MixxxControls.Group>(
    group: TGroup,
    name: MixxxControls.CtrlRW<TGroup>,
    enable: boolean,
  ): void;
   ...
   * @param name Name of the control e.g. "pregain"
   */
  function softTakeoverIgnoreNextValue<TGroup extends MixxxControls.Group>(
    group: TGroup,
    name: MixxxControls.CtrlRW<TGroup>,
  ): void;
