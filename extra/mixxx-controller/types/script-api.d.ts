 ...
 */
declare function stringifyObject<T>(
  obj: T,
  maxdepth?: number,
  checked?: unknown[],
  prefix?: string,
...
declare namespace script {
  ...
  function bindConnections<TGroup extends MixxxControls.Group>(
    group: TGroup,
    controlsToFunctions: Partial<
      Record<MixxxControls.Ctrl<TGroup>, engine.CoCallback<TGroup>>
    >,
    remove?: boolean,
  ): void;
   ...
   */
  function toggleControl<TGroup extends MixxxControls.Group>(
    group: TGroup,
    control: MixxxControls.CtrlRW<TGroup>,
  ): void;
   ...
   */
  function triggerControl<TGroup extends MixxxControls.Group>(
    group: TGroup,
    control: MixxxControls.CtrlRW<TGroup>,
    delay?: number,
  ): void;
   ...
   */
  function loopMove<TGroup extends MixxxControls.Group>(
    group: TGroup,
    direction: number,
