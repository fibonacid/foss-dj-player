...
declare namespace MixxxControls {
  ...
  namespace ReadOnly {
    ...
    type ReadOnlyControls = {
      ...
      ]: ReadOnly.ReadOnlyEqualizerRack1ChannelIControl;
      [
        key: `[EqualizerRack1_[Channel${number}]_Effect1]`
      ]: ReadOnly.ReadOnlyEqualizerRack1ChannelIEffect1Control;
      [key: `[Microphone${number}]`]: ReadOnly.ReadOnlyMicrophoneNControl;
      [key: `[PreviewDeck${number}]`]: ReadOnly.ReadOnlyPreviewDeckNControl;
      [
        key: `[QuickEffectRack1_[Channel${number}]]`
      ]: ReadOnly.ReadOnlyQuickEffectRack1ChannelIControl;
      [
        key: `[QuickEffectRack1_[Channel${number}]_Effect1]`
  ...
  namespace Deprecated {
    ...
    type DeprecatedPreviewDeckNControl =
      DeprecatedChannelNPreviewDeckNSamplerNControl;

    type DeprecatedQuickEffectRack1ChannelIControl =
      DeprecatedEffectRack1EffectUnitNEqualizerRack1ChannelIQuickEffectRack1ChannelIControl;

    type DeprecatedSamplerNControl =
      DeprecatedChannelNPreviewDeckNSamplerNControl;
  }
