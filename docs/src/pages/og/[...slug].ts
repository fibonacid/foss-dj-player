...
export const { getStaticPaths, GET } = await OGImageRoute({
  ...
  getImageOptions: (_id, page: (typeof pages)[number]) => {
    return {
      ...
      font: {
        title: {
          families: ["ComicShannsMono", "Nerd Font"],
        },
        description: {
          families: ["Inter"],
          // color: ["63", "63", "69"],
      ...
      fonts: [
        "./src/fonts/ComicShannsMonoNerdFont-Regular.woff2",
        "./src/fonts/inter-latin-300-normal.woff2",
      ],
      // logo: {
      //   path: "./src/assets/fdjp_dark_2xl.png",
      // },
    };
  },
});
